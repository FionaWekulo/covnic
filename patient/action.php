	...
	if($_POST['action'] == 'patient_register')
	{
		...
		else
		{
			...
			$object->execute($data);
				...
				$mail->Username = 'fionawekulo18@gmail.com';                 // SMTP username
				$mail->Password = 'Fifi4cutie2019.';                           // SMTP password
				$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
				$mail->Port = 587;                                    // TCP port to connect to

				$mail->setFrom('fionawekulo18@gmail.com', 'Covnic');
				$mail->addAddress($_POST['patient_email_address']);     // Add a recipient
							
				$mail->addReplyTo('fionawekulo18@gmail.com');
				$mail->Subject = 'Email verification';
				$message_body = '
							<p>Welcome to Covnic!</p> 
							<p>To verify your email address, Please click on this <a href="'.$object->base_url.'patient/verify.php?code='.$patient_verification_code.'"><b>link</b></a>.</p>
							';
