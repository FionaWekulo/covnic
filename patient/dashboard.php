	...
	<br />
		<div class="card-header"><h4>Available Doctors</h4></div>
				<div class="table" width ="100%">
		      		<table class="table" id="appointment_list_table" width ="100%">
					  <thead>
                                        <tr>
                                        <th>ScheduleID</th>
                                            <th>Doctor email</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT doctor_schedule_id, doctor_email, doctor_schedule_date  ,doctor_schedule_start_time,doctor_schedule_end_time 
