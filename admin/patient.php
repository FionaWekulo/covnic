...
<div class="main-content">
    <header>
        ...
        <div class="user-wrapper">
            <img src="../image/pic1.png" width="30px" height="30px" alt="">
           <div>
               <h4>Admin</h4>
               <br>
	...
	<br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h3 class="m-0 font-weight-bold text-primary">Patient List</h3>
                            	</div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="doctor_table" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT patient_first_name , patient_last_name, patient_email_address,
                                       patient_phone_no, email_verify FROM patient_table";
