    ...
    <div class="main-content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col">
                        <h3 class="m-0 font-weight-bold text-primary">Doctor Schedule List</h3>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="doctor_table" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT doctor_email, doctor_schedule_date  ,doctor_schedule_start_time,doctor_schedule_end_time  FROM doctor_schedule_table";
