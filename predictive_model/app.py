...
def predict():
   ...
   # accuracy = model.predict([0])
    return render_template("result.html", prediction_text = "Kindly make an appointment with one of our doctors for actual testing.\n Your Covid status is likely to be {}".format(prediction) )
