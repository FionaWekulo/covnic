...
if(isset($_POST['doctorschedule']))
{
         ...
         //exit();
			...
			$insert = "INSERT INTO doctor_schedule_table 
                (doctor_email, doctor_schedule_date, doctor_schedule_start_time, doctor_schedule_end_time) 
			VALUES ('$doctor_email', '$doctor_schedule_date', '$doctor_schedule_start_time	', '$doctor_schedule_end_time');";
...
<br>
<br>
<br><br><h1 class="heading"> <span>SCHEDULE </span>APPOINTMENT</h1>  
...
<div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Your Doctor email <span class="text-danger">*</span></label>
