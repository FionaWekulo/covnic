...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1961777944ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=patient_table">`covid`.`patient_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=doctor_schedule_table">`covid`.`doctor_schedule_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=appointment_table">`covid`.`appointment_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=doctor_table">`covid`.`doctor_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=vaccination">`covid`.`vaccination`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=reviews">`covid`.`reviews`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=categories">`covid`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=covid&table=contact">`covid`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chatapp&table=users">`chatapp`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myblog&table=posts">`myblog`.`posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="305137595b537a38382a7a6a417b4b4a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="covid" targettable="patient_table">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `patient_table`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="covid" targettable="patient_table">
                            <div class="action_content">
